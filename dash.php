            ...
            <div class="mdl-grid">
               ...
               <div class="mdl-shadow--2dp mdl-cell" style="background-color:#3c3a3f">
                  <div class="mdl-card-title">
                     <center><iframe src="http://76.106.118.56:443/picture/1/frame/" height="240"></iframe></center>
                  </div>
               </div>
               <!-- View 2 -->
               <div onclick="location.href='http://76.106.118.56:443/';" class="mdl-shadow--2dp mdl-cell" style="background-color:#3c3a3f">
                  <div class="mdl-card-title">
                     <center><iframe src="http://76.106.118.56:443/picture/2/frame/" height="240"></iframe></center>
                  </div>
               </div>
               <!--View 3 -->
               <div onclick="location.href='http://76.106.118.56:443/';" class="mdl-shadow--2dp mdl-cell" style="background-color:#3c3a3f">
                  <div class="mdl-card-title">
                     <center><iframe src="http://76.106.118.56:443/picture/3/frame/" height="240"></iframe></center>
                  </div>
               </div>
               <!--View 4 -->
                <!-- Christmas Lights -->
